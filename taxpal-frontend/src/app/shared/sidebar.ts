  ...
  template: `
    <aside class="sidebar" [class.open]="isOpen">
      ...
      <nav class="sidebar-nav">
        ...
        <a class="nav-item" routerLink="/tax-estimator" routerLinkActive="active" (click)="onNavClick()">
          <svg class="nav-icon" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
        ...
        <a class="nav-item" routerLink="/reports" routerLinkActive="active" (click)="onNavClick()">
          <svg class="nav-icon" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">

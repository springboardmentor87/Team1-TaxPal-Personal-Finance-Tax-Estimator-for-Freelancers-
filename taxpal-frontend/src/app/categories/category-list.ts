        ...
        <div
          ...
          *ngIf="toastMsg"
          ...
          <button
            ...
            (click)="dismissToast(); $event.stopPropagation()">
        ...
        <div class="page-container">
          ...
          <div class="settings-grid">
            ...
            <div class="card settings-content-card">
              ...
              <div
                *ngIf="activeSettingsTab === 'profile'"
                class="tab-panel">
              ...
              <div
                *ngIf="activeSettingsTab === 'categories'"
                class="tab-panel">
              ...
              <div
                *ngIf="activeSettingsTab === 'notifications'"
                class="tab-panel">
                ...
                <div class="panel-header">
                  ...
                  <p class="panel-subtitle">
                    Configure alerts for budgets, tax deadlines, and account digests.
                  </p>
                ...
                <div class="toggle-list">
                  ...
                  <div class="toggle-row">
                    ...
                    <div>
                      ...
                      <div class="toggle-desc">
                        Receive instant notifications when category spending exceeds 80% limit
                      </div>
                    ...
                    <label class="switch">
                      ...
                      <input
                        type="checkbox"
                        [(ngModel)]="notifSettings.budgetAlerts">
                  ...
                  <div class="toggle-row">
                    ...
                    <div>
                      ...
                      <div class="toggle-title">
                        Quarterly Tax Due Reminders
                      </div>

                      <div class="toggle-desc">
                        Schedule email alerts 15 days before quarterly tax filing due dates
                      </div>
                    ...
                    <label class="switch">
                      ...
                      <input
                        type="checkbox"
                        [(ngModel)]="notifSettings.taxReminders">
                  ...
                  <div class="toggle-row">
                    ...
                    <div>
                      ...
                      <div class="toggle-desc">
                        Weekly email digest summarizing total income, expenses, and savings rate
                      </div>
                    ...
                    <label class="switch">
                      ...
                      <input
                        type="checkbox"
                        [(ngModel)]="notifSettings.weeklySummary">
                  ...
                  <div class="toggle-row">
                    ...
                    <div>
                      ...
                      <div class="toggle-desc">
                        Receive security alerts for new device sign-ins and password updates
                      </div>
                    ...
                    <label class="switch">
                      ...
                      <input
                        type="checkbox"
                        [(ngModel)]="notifSettings.securityAlerts">
              ...
              <div
                *ngIf="activeSettingsTab === 'security'"
                class="tab-panel">
...
export class CategoryListComponent implements OnInit, OnDestroy {
  ...
  profileForm = new FormGroup({
    ...
    income_bracket: new FormControl(
      'Freelancer',
      {
        nonNullable: true,
        validators: [Validators.required]
  ...
  ngOnInit(): void {
    ...
    const currentCountry =
      this.currencyService.currentCountry;
    ...
    if (this.currentUser) {
      ...
      this.profileForm.patchValue({
        ...
        income_bracket:
          this.currentUser.income_bracket ||
          'Freelancer'
  ...
  onCountryChange(
    ...
    if (
      ...
      this.showToast(
        `Currency updated to ${this.currencyService.currentSymbol} (${this.currencyService.currentCode})`
      );
